...
func WebSocket(c *gin.Context) {
	...
	// !=========================Save connection into local slice  ============================
	// ? Note ( the connection could be save only localy but not for sure )
	// ? Local changes (could be modefied)
	mongoconn.Connection()
